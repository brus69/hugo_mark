...
Третья модель сегментации — это источник привлечения, который используется для анализа различий между пользователями в зависимости от того, где они были привлечены. Общие источники включают органический поиск, поиск в Google и рекламу в Facebook.
