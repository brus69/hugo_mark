...
* как и эксперименты, ММА также зависят от инициатив по защите конфиденциальности пользовательских данных, таких как Apple no IDFA и VK no AMM. В обозримом будущем к ним присоединится Google. Без данных отслеживания на уровне пользователей модели ММА не могут быть построены.
