...
Вскоре после того, как ChatGPT стал популярным в ноябре 2022 года, пользователи поняли, что LLM не были обучены на их собственных данных. Чтобы восполнить этот пробел, команды начали разрабатывать способы извлечения релевантных данных во время запроса для дополнения запроса — подход, известный как генерация с дополнением на основе извлечения (RAG). Термин появился в статье Meta в 2020 году, но популярность моделей GPT сделала этот термин и практику широко известными.
