...
В стартапах Кремниевой долины этот момент часто называют «магическим числом». Для Facebook добавление одного друга — это ещё не всё. Долгосрочные активные пользователи, как правило, добавляют семь друзей за десять дней.
