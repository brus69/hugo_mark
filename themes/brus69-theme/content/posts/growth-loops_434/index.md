...
**Углубитесь в циклы роста + модели** в программе Advanced Growth Strategy вместе с другими опытными практиками из Google, Facebook, Spotify, Adobe, HubSpot и многих других. Мы рассмотрим свойства, которые делают цикл, подробные примеры более чем 20 циклов роста, способы измерения/анализа ваших циклов и способы построения количественных моделей.
