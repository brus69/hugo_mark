...
* Мы прибегаем к модели временных рядов Prophet от Meta, чтобы разложить наш временной ряд на тренд и сезонность, и используем их в качестве управляющих переменных.
